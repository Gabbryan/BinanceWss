...
class Config:
    def __init__(self):
        load_dotenv()
        self.CONFIG_PATH = "../src/cores/cicada-ingestion/data-providers/Binance/sources/ingestion-live-wss/config.conf"
        self.LOG_DIR = "../src/cores/cicada-ingestion/data-providers/Binance/sources/ingestion-live-wss/logs"
