...
<<<<<<< HEAD:cores/aggTrades/historical/transformation/src/run_pipeline.py
...
log_file_path = os.getenv("LOG_FILE_PATH", "/root/Trustia/Cicada-binance/cores/aggTrades/historical/transformation/src/app.log")
...
>>>>>>> f21e1a5a (pipeline_analysis):cores/aggTrades/historical/transformation/src/main_GCS_complete.py
)
