...
path_output = "Transformed/{assets}/{brokers}/{bars}/{symbol}/{timeframe}/{indicators}/data_{start_year:02d}_{start_month:02d}_{start_day:02d}_{end_year:02d}_{end_month:02d}_{end_day:02d}"

"""
from datetime import datetime
from src.cores.cicada_transformation.indicators.ta_lib.talib_processing_controller import TransformationTalib
