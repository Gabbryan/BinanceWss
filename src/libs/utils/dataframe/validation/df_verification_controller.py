...
if __name__ == "__main__":
    ...
    df3 = pd.DataFrame({'Open': [1.0, 2.0, 3.0], 'High': [1.2, 2.2, 3.2], 'Low': [0.9, 1.9, 2.9], 'Close': [1.1, 2.1, 3.1], 'Volume': [100, 200, 300], 'Date': ['2023-10-01', '2023-10-02', 'Invalid Date']})
    df4 = pd.DataFrame({'Something': [1, 2, 3], 'Else': [10, 20, 30], 'Another': [5, 6, 7]})
    df5 = pd.DataFrame({'Open': [1.0, 2.0, 3.0], 'High': [1.2, 2.2, 3.2], 'Low': [0.9, 1.9, 2.9], 'Close': [1.1, 2.1, 3.1], 'Volume': [100, 200, 300], 'Date': ['2023-10-01', '2023-10-02', 'Invalid Date'], 'Created_date': ['2023-10-01', '2023-10-02', '2023-10-03']})
